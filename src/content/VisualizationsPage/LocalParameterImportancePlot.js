...
const trace1 = {
  ...
  x: ['dropout', 'learning_rate[0]', 'learning_rate[1]', 'learning_rate[2]', 'mt-join'], 
  ysrc: 'xavier.bouthillier:5:422bb6', 
  y: [0.32748907262798554, 0.40220705535636964, 0.24271159795845018, 0.027485052593809525, 0.00010722146338502284]
};
const data = [trace1];
const layout = {
